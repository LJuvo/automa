...
export const users: User[] = [
  { id: 'u01', username: 'zhanggong', name: '张工', organization: '蓉江新区厂', role: '工程师', phone: '138****5678', status: '启用', createdAt: '2025-03-15' },
  ...
  { id: 'u06', username: 'liuoperator', name: '刘操作', organization: '金风梅园厂', role: '操作员', phone: '134****5678', status: '禁用', createdAt: '2025-07-01' },
